...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "gmapsej" because\n';
  ...
  $wnd.__gwt_activeModules['gmapsej'] = {
    'moduleName' : 'gmapsej',
    'bindings' : function() {
      return {};
    }
 ...
 * "/gmapsej.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['gmapsej'].superdevmode = true;

  var expectedSuffix = '/gmapsej.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + gmapsej + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:gmapsej';
  var devModeSessionKey = '__gwtDevModeSession:gmapsej';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/gmapsej/gmapsej.nocache.js';
  ...
  $wnd.__gwt_activeModules['gmapsej'].canRedirect = true;
  $wnd.__gwt_activeModules['gmapsej'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/gmapsej?user.agent=' + ua + '&_callback=' + callback;
